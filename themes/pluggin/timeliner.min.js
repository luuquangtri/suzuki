...
!function(e) {
  function n(n) {
    ...
    var r = {
      ...
      baseSpeed: n.baseSpeed || 10,
      speed: n.speed || 4,
      fontOpen: n.fontOpen || "0.9em",
      fontClosed: n.fontClosed || "0.7em",
      expandAllText: n.expandAllText || "+ Mở tất cả",
      collapseAllText: n.collapseAllText || "- Đóng tất cả"
    };
